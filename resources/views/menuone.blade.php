...
<section class="menu-one">
    <div class="right-bg"><img src="assets/images/background/bg-16.png" alt="" title=""></div>
    <div class="auto-container">
        ...
        <div class="row clearfix">
            <div class="image-col col-lg-7 col-md-12 col-sm-12">
                <div class="inner">
                    <div class="image"><img src="assets/images/resource/menus-1.jpg" alt=""></div>
                </div>
            </div>
                ...
                <div class="inner">
                    ...
                    <div class="dish-block">
                        <div class="inner-box">
                            ...
                            <div class="text desc"><a href="#">Tomatoes, green bell pepper, sliced cucumber onion,
                                    olives, and feta cheese.</a></div>
                        </div>
                    </div>
                    <!--Block-->
                    <div class="dish-block">
                    ...
                    <div class="dish-block">
                        <div class="inner-box">
                            ...
                            <div class="text desc"><a href="#">Typesetting industry lorem Lorem Ipsum is simply dummy
                                    text of the priand.</a></div>
                        </div>
                    </div>
                    <!--Block-->
                    <div class="dish-block">
...
<section class="menu-one alternate">
    <div class="left-bg"><img src="assets/images/background/bg-17.png" alt="" title=""></div>
    <div class="right-bg-2"><img src="assets/images/background/bg-18.png" alt="" title=""></div>
    <div class="auto-container">
        <div class="title-box centered">
        ...
        <div class="row clearfix">
            <div class="image-col col-lg-7 col-md-12 col-sm-12">
                <div class="inner">
                    <div class="image"><img src="assets/images/resource/menus-2.jpg" alt=""></div>
                </div>
            </div>
            <div class="menu-col col-lg-5 col-md-12 col-sm-12">
                <div class="inner">
...
<!--Menu Section-->
<section class="menu-one">
    <div class="left-bg"><img src="assets/images/background/bg-22.png" alt="" title=""></div>
    <div class="auto-container">
        <div class="title-box centered">
        ...
        <div class="row clearfix">
            <div class="image-col col-lg-7 col-md-12 col-sm-12">
                <div class="inner">
                    <div class="image"><img src="assets/images/resource/menus-desert.jpg" alt=""></div>
                </div>
            </div>
            <div class="menu-col col-lg-5 col-md-12 col-sm-12">
                <div class="inner">
...
<section class="menu-one alternate">
    ...
    <div class="right-bg-2"><img src="assets/images/background/bg-23.png" alt="" title=""></div>
    <div class="auto-container">
        <div class="title-box centered">
        ...
        <div class="row clearfix">
            <div class="image-col col-lg-7 col-md-12 col-sm-12">
                <div class="inner">
                    <div class="image"><img src="assets/images/resource/menus-drinks.jpg" alt=""></div>
                </div>
            </div>
            <div class="menu-col col-lg-5 col-md-12 col-sm-12">
                <div class="inner">
