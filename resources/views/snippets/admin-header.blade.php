...
{{-- <div class="nav-header">
    <a href="index.html" class="brand-logo">
        ...
        <img class="logo-compact" src="admin_assets/images/logo.png" alt="/">
        <img class="brand-title" src="admin_assets/images/logo.png" alt="/">
    </a> --}}
            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        Dashboard
                        <span>Welcome to Delici Admin!</span>
                    </div>
                </div>
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                            <img src="/admin_assets/images/profile/dishdelici.png" width="20" alt="/">
