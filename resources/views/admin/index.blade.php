                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="/admin_assets/images/avatar/1.jpg" class="rounded-circle user_img"
                                            alt="/">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="/admin_assets/images/avatar/2.jpg" class="rounded-circle user_img"
                                            alt="/">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="/admin_assets/images/avatar/3.jpg" class="rounded-circle user_img"
                                            alt="/">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="/admin_assets/images/avatar/4.jpg" class="rounded-circle user_img"
                                            alt="/">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="/admin_assets/images/avatar/5.jpg" class="rounded-circle user_img"
                                            alt="/">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                    ...
                    <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="/admin_assets/images/avatar/1.jpg" class="rounded-circle user_img_msg"
                                    alt="/">
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <div class="img_cont_msg">
                                <img src="/admin_assets/images/avatar/2.jpg" class="rounded-circle user_img_msg"
                                    alt="/">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
                        ...
                        <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                            ...
                            <div class="me-auto pe-3">
                                <a href="post-details.html">
                                    <h2 class="text-black fs-14">Medium Spicy Spagethi Italiano</h2>
                                </a>
                                <span class="text-black font-w600 d-inline-block me-3">$5.6 </span>
                                <span class="fs-14">Order 89x</span>
                            </div>
                            <img src="/admin_assets/images/menus/9.png" alt="/" width="60" class="rounded">
                        </div>
                        <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                            <span class="num">#2</span>
                            <div class="me-auto pe-3">
                                <a href="post-details.html">
                                    <h2 class="text-black fs-14">Watermelon juice with ice</h2>
                                </a>
                                <span class="text-black font-w600 d-inline-block me-3">$5.6 </span>
                                <span class="fs-14">Order 89x</span>
                            </div>
                            <img src="/admin_assets/images/menus/10.png" alt="/" width="60" class="rounded">
                        </div>
                        <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                            <span class="num">#3</span>
                            <div class="me-auto pe-3">
                                <a href="post-details.html">
                                    <h2 class="text-black fs-14">Chicken curry special with cucumber
                                    </h2>
                                </a>
                                <span class="text-black font-w600 d-inline-block me-3">$5.6 </span>
                                <span class="fs-14">Order 89x</span>
                            </div>
                            <img src="/admin_assets/images/menus/11.png" alt="/" width="60" class="rounded">
                        </div>
                        <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                            <span class="num">#4</span>
                            <div class="me-auto pe-3">
                                <a href="post-details.html">
                                    <h2 class="text-black fs-14">Italiano Pizza With Garlic</h2>
                                </a>
                                <span class="text-black font-w600 d-inline-block me-3">$5.6 </span>
                                <span class="fs-14">Order 89x</span>
                            </div>
                            <img src="/admin_assets/images/menus/12.png" alt="/" width="60" class="rounded">
                        </div>
                        <div class="d-flex tr-row align-items-center">
                            <span class="num">#5</span>
                            <div class="me-auto pe-3">
                                <a href="post-details.html">
                                    <h2 class="text-black fs-14">Tuna Soup spinach with himalaya salt
                                    </h2>
                                </a>
                                <span class="text-black font-w600 d-inline-block me-3">$5.6 </span>
                                <span class="fs-14">Order 89x</span>
...
<div class="row">
    <div class="col-md-3">
        <div class="card bg-primary text-white p-3">
            ...
            <h3>{{ $dailyReservations }}</h3>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card bg-success text-white p-3">
            <h5>This Week's Reservations</h5>
            <h3>{{ $weeklyReservations }}</h3>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="card mt-4">
        <div class="card-body">
            <h5>Peak Booking Times</h5>
            <canvas id="peakTimeChart" height="100"></canvas>
        </div>
    </div>

    <script>
        const ctx = document.getElementById('peakTimeChart').getContext('2d');
const peakTimeChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: {!! json_encode($peakTimeData->pluck('hour')) !!},
        datasets: [{
            label: 'Bookings',
            data: {!! json_encode($peakTimeData->pluck('total')) !!},
